...
public class Feedback_Saran extends AppCompatActivity {

    private TextInputEditText etsaran;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etsaran = (TextInputEditText) findViewById(R.id.edittextt);
        UploadButton = (Button)findViewById(R.id.uploadbuttonn);

        UploadButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String pesan = etsaran.getText().toString();
    ...
    private void openWhatsApp() {
        ...
        i.putExtra(Intent.EXTRA_TEXT, ""+etsaran.getText());
        startActivity(i);
    }
}
